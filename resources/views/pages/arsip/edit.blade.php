                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h2 class="m-0 font-weight-bold">SOP BRMP JAMBI >> Edit</h2>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2 mt-3">
                            ...
                            <div class="form-group" style="padding-right: 20px; padding-left: 20px;">
                                ...
                                <input type="date" name="tanggal_pembuatan" class="form-control" value="{{ $arsip->tanggal_pembuatan }}">
                            </div>
                            <div class="form-group" style="padding-right: 20px; padding-left: 20px;">
                                <label for="tanggal_revisi">Tanggal Revisi</label>
                                <input type="date" name="tanggal_revisi" class="form-control" value="{{ $arsip->tanggal_revisi }}">
                            </div>
                            <div class="form-group" style="padding-right: 20px; padding-left: 20px;">
